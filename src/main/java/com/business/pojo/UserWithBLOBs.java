...
//    }
    ...
    public UserWithBLOBs(Integer id, String accountNumber, String password, Integer businessId, byte[] sslCipher, byte[] x509Issuer, byte[] x509Subject, String authenticationString, String userAttributes) {
        super(id, accountNumber, password, businessId);
        this.sslCipher = sslCipher;
        this.x509Issuer = x509Issuer;
        this.x509Subject = x509Subject;
        this.authenticationString = authenticationString;
    ...
    public UserWithBLOBs(byte[] sslCipher, byte[] x509Issuer, byte[] x509Subject, String authenticationString, String userAttributes) {
        this.sslCipher = sslCipher;
        this.x509Issuer = x509Issuer;
        this.x509Subject = x509Subject;
        this.authenticationString = authenticationString;
